...
namespace EnterpriseGames.UI.Forms.EditForms
{
    public partial class ReportMakerForm : MetroForm
    {
        ...
        private void btnSaveReport_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroMessageBox.Show(this, "Отчёт успешно сформирован", "Уведомление", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MetroMessageBox.Show(this, "Не удалось сформировать отчёт", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
