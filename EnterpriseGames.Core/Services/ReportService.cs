...
namespace EnterpriseGames.Core.Services
{
    ...
    public class ReportService
    {
        ...
        {
            var filename = Path.Combine(folder, $"Рейтинг услуг {DateTime.Now:d}.xlsx");

            using (ExcelPackage excelPackage = CreateExcelPackage(filename, author, "Рейтинг услуг"))
            {
                var workSheet = excelPackage.Workbook.Worksheets.Add("Рейтинг услуг");

                workSheet.Cells["A1:M1"].Merge = true;
                workSheet.Cells["A1"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                workSheet.Cells["A1"].Style.Font.Bold = true;
                workSheet.Cells["A1"].Style.Font.Size = 14;
                workSheet.Cells["A1"].Value = $"Рейтинг услуг ({start} - {end})";

                workSheet.Cells["A2:E2"].Merge = true;
                workSheet.Cells["A2:E2"].Value = "Название услуги";
                workSheet.Cells["A2:E2"].Style.Font.Bold = true;

                workSheet.Cells["F2:G2"].Merge = true;
                workSheet.Cells["F2:G2"].Value = "Создана";
                workSheet.Cells["F2:G2"].Style.Font.Bold = true;

                workSheet.Cells["H2:I2"].Merge = true;
                workSheet.Cells["H2:I2"].Value = "Стоимость";
                ...
                workSheet.Cells["L2:M2"].Value = "Сумма";
                ...
                foreach (var item in items)
                {
                    ...
                    workSheet.Cells[$"L{line}:M{line}"].Style.Numberformat.Format = @"0,00 ₽";
        ...
        {
            var filename = Path.Combine(folder, $"Рейтинг клиентов {DateTime.Now:d}.xlsx");

            using (ExcelPackage excelPackage = CreateExcelPackage(filename, author, "Рейтинг клиентов"))
            {
                var workSheet = excelPackage.Workbook.Worksheets.Add("Рейтинг клиентов");

                workSheet.Cells["A1:I1"].Merge = true;
                workSheet.Cells["A1"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                workSheet.Cells["A1"].Style.Font.Bold = true;
                workSheet.Cells["A1"].Style.Font.Size = 14;
                workSheet.Cells["A1"].Value = $"Рейтинг клиентов ({start} - {end})";

                workSheet.Cells["A2:E2"].Merge = true;
                workSheet.Cells["A2:E2"].Value = "ФИО";
                workSheet.Cells["A2:E2"].Style.Font.Bold = true;

                workSheet.Cells["F2:G2"].Merge = true;
                workSheet.Cells["F2:G2"].Value = "Куплено услуг";
                workSheet.Cells["F2:G2"].Style.Font.Bold = true;

                workSheet.Cells["H2:I2"].Merge = true;
                workSheet.Cells["H2:I2"].Value = "Сумма";
                workSheet.Cells["H2:I2"].Style.Font.Bold = true;
        ...
        {
            var filename = Path.Combine(folder, $"Заказы {DateTime.Now:d}.xlsx");

            using (ExcelPackage excelPackage = CreateExcelPackage(filename, author, "Заказы"))
            {
                ...
                workSheet.Cells["I2:J2"].Value = "Кол-во услуг";
